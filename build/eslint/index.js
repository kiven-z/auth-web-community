...
export const SOURCE_GLOB = '**/*.{ts,tsx,vue,js,jsx}';

const authLocalPlugin = {
  rules: {
    'feature-import-boundary': featureImportBoundary,
    'no-component-self-barrel-import': noComponentSelfBarrelImport,
  },
};
...
export default defineConfig([
  ...
  {
    files: [`src/${SOURCE_GLOB}`],
    plugins: {
      'auth-local': authLocalPlugin,
    },
    rules: {
      'auth-local/feature-import-boundary': 'error',
    },
  },
  {
    ...
    rules: {
      'auth-local/no-component-self-barrel-import': 'error',
    },
  },
]);
