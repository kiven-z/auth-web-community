...
import { resolveColdStartNavigation } from '@/router/guards/auth/cold-start';
...
vi.mock('@/auth/permission/has-auth', () => ({
  hasAuth: vi.fn(),
}));

vi.mock('@/auth/permission/is-one-of-array', () => ({
  isOneOfArray: vi.fn(),
}));

vi.mock('@/core/session/profile/user-profile-storage', () => ({
