import { attachRequestAuthInterceptor } from '@/core/http/interceptors/requestAuth';
...
vi.mock('@/core/session/sessionAuth', () => ({
  isLoggedIn: isLoggedInMock,
}));

vi.mock('@/core/session/token/accessTokenReady', () => ({
