 ...
 * 回收站分页查询
 */
export function getFileRecyclePage(params: FileRecordPageQuery) {
 ...
 * @returns 文件记录详情
 */
export function getFileRecycleDetail(id: string) {
 ...
 * 回收站批量恢复
 */
export function restoreFileRecycle(ids: string[]) {
 ...
 * 回收站批量彻底删除
 */
export function purgeFileRecycle(ids: string[]) {
