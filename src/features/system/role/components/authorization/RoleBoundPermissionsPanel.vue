...
import type { RolePermissionPageQuery } from '@/features/system/api/role/roleAuthorization';
...
import usePermissionColumns from '@/features/system/_shared/columns/usePermissionColumns';
