...
import DataTable, { type DataTableAdaptiveConfig, type DataTableAdaptiveMode } from '@/components/table/DataTable';
...
import { useListTableColumns } from './hooks/useListTableColumns';
import { useTreeExpandAll } from './hooks/useTreeExpandAll';
